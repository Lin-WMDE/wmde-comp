...
// WMDE: TiledCorners is expressed as a snap cell and computes its geometry there, so the
// drag-to-edge path and the layout strip share one definition - see shell::layout::floating::snap.
